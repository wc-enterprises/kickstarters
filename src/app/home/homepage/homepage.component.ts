...
<div class="title-mobile">
    <p id="sub-title-mobile">
        The main page with<br>heading
    </p>
    <p id="sub-title2-mobile">Inspiring gym apparel for athletes and fitness <br>enthusiasts.
        Push your limits, surpass your <br> goals, move forward.</p>
